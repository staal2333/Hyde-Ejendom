    ...
    <div className="mb-4">
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          {running && <div className="w-2 h-2 rounded-full bg-brand-500 animate-gentle-pulse shadow-sm shadow-brand-500/40" />}
      ...
      <div className="w-full h-2.5 bg-slate-100 rounded-full overflow-hidden" style={{ boxShadow: "inset 0 1px 2px rgba(0,0,0,0.06)" }}>
        <div
        ...
        >
          {running && !isDone && pct > 5 && (
            <div className="absolute right-0 top-[-2px] bottom-[-2px] w-5 rounded-full"
              style={{
